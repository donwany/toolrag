...
# ============================================================================
# TOOL DEFINITIONS (These are stored as descriptors in vector DB)
# ============================================================================
...
# ============================================================================
# MOCK MCP TOOLS (Simulating actual tool execution)
# ============================================================================

@tool
def weather_get_forecast(city: str, units: str = "metric") -> dict:
    ...
    return {
        ...
        "forecast": [
            ...
            {"day": "Wednesday", "temp": 24, "condition": "Rainy"},
            {"day": "Thursday", "temp": 25, "condition": "Cloudy"},
            {"day": "Friday", "temp": 27, "condition": "Sunny"},
            {"day": "Saturday", "temp": 29, "condition": "Sunny"},
            {"day": "Sunday", "temp": 28, "condition": "Partly Cloudy"}
        ]
    }


@tool
def calendar_get_events(start_date: str, end_date: str) -> dict:
    """Retrieve calendar events for a date range"""
    return {
        "events": [
            {"date": "2026-01-27", "time": "10:00", "title": "Team Meeting"},
            {"date": "2026-01-28", "time": "14:00", "title": "Client Call"},
            {"date": "2026-01-29", "time": "09:00", "title": "Project Review"}
        ]
    }


@tool
def stock_get_price(symbol: str, exchange: str = "NASDAQ") -> dict:
